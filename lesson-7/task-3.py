...
class Cell:
    ...
    def __sub__(self, other):
        ...
        if result <= 0:
            ...
            return 'Результат не может быть меньше или равен нулю'
...
print(f'sub: {cell_2 - cell_1}')
print(f'mul: {cell_2 * cell_1}')
print(f'truediv: {cell_2 / cell_1}')
print(f'truediv: {cell_1 / cell_2}')
print(f'make_order:\n{cell_1.make_order(5)}', end='\n\n')
print(f'make_order:\n{cell_2.make_order(8)}')
